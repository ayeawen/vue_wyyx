  ...
  <div id="user">
    <div class="head">
      <div class="content">
        ...
        <div class="headLeft">
          <a class="search" href="javascript:;" @click="toSearch">
    ...
    <div class="main">
      <div class="top">
        ...
        <div class="btnWrap">
          ...
          <a href="javascript:;" class="quickRegister">
            <span>手机号快捷注册</span>
            <img src="/static/img/login/arrow-right3-8d47138d73.png" alt="">
          </a>
        </div>
      </div>
      <div class="other">
      ...
      .content
        ...
        a
          h1
            width 48px
            height 44px
            background url('/static/img/login/hd-s9f33319f5a-b1aa4c35e6.png') no-repeat
          ...
          button
            ...
            &.phone
              ...
              i
                ...
                width 40px
                height 40px
                background url("/static/img/login/login-s2d0d826858-156f617841.png") no-repeat
